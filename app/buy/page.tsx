        ...
        <div className="flex-1 animate-fade-in-up delay-200">
              ...
              <div key={bike.id} className="bg-white shadow-sm hover:shadow-lg transition-all duration-300 group flex flex-col border border-transparent hover:border-gray-200">
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className="absolute top-3 left-3 flex gap-2">
                    <span className="bg-white text-[#051b3d] text-[10px] flex items-center gap-1 uppercase tracking-widest font-bold px-3 py-1 shadow-sm"><ShieldCheck size={12}/> Verified</span>
                ...
                <div className="p-8 flex-1 flex flex-col">
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-auto">
                    <button className="py-3 px-4 border border-gray-300 hover:border-[#051b3d] text-[#051b3d] font-semibold text-xs uppercase tracking-widest transition-colors text-center">View</button>
                    <button className="py-3 px-4 bg-[#ef6a22] hover:bg-[#d95714] text-white font-semibold text-xs uppercase tracking-widest transition-colors text-center">Contact</button>
                  </div>
                </div>
              </div>
            ))}
          ...
          {filteredAndSortedBikes.length === 0 && (
            <div className="text-center py-20 bg-white rounded-2xl border border-gray-200 shadow-sm">
              ...
              <button 
                onClick={() => {setFilters({city:"All", ownership:"All", year:"All"}); setPriceRange(300000);}}
